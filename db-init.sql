...
INSERT INTO event_store.events (stream_id, version, event_type, data, metadata) VALUES 
    ...
    '{"user_id": "f6d9g82b-10cb-4567-9012-67890abcdef1", "title":"Blue t-shirt","price":"15","description":"Rock the casual look with this comfy blue t-shirt, perfect for your everyday adventures. It is a great go-to shirt that is easy to pair with anything and is ready for its new home!"}'::jsonb, '{}'::jsonb);
